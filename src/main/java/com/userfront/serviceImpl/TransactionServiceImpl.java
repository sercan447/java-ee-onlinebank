...
public class TransactionServiceImpl implements TransactionService {
	...
	public List<SavingsTransaction> findSavingTransactionList(String username) {
		...
		User user = userService.findByUsername(username);
		List<SavingsTransaction> savingsTransactionList = user.getSavingsAcoount().getSavingsTransactionList();
	...
	public void deleteRecipientByName(String recipientName) {
		recipientDao.findByName(recipientName);
	}
	...
	public void toSomeoneElseTransfer(Recipient recipient, String accountType, String amount,
		...
		}else if(accountType.equalsIgnoreCase("Savings"))
		{
			...
			SavingsTransaction savingsTransaction = new SavingsTransaction(date,"Transfer to recipient"+recipient.getName(),
