...
public class AccountServiceImpl implements AccountService{
	...
	public void deposit(String accountType, double amount, Principal principal) {
		...
		{
			SavingsAccount savingsAccount = user.getSavingsAcoount();
			savingsAccount.setAccountBalance(savingsAccount.getAccountBalance().add(new BigDecimal(amount)));
			savingsAccountDao.save(savingsAccount);
			
			Date date = new Date();
			SavingsTransaction savingsTransaction =
					new SavingsTransaction(date,"Deposito to savings Account","Account","Finished",
	...
	public void withdraw(String accountType, double amount, Principal principal) {
		...
		if(accountType.equalsIgnoreCase("Primary"))
		{
			...
			PrimaryTransaction primaryTransaction = new PrimaryTransaction(date,"With from primary Account","Account",
